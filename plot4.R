...
plot4 <- function(path){
  ##create the png file
  png(filename = "plot4.png",width = 480, height = 480, units = "px", pointsize = 12,type = c("windows", "cairo","cairo-png"))
  ...
  ##Set the rows and columns for the graph
  par(mfrow = c(2, 2), mar = c(4, 4, 2, 1), oma = c(0, 0, 2, 0))
  ##Creating the graph with the data 
  with(re, {
    plot(re$Date,re$Global_active_power,type="l", ylab="Global Active Power", xlab="")
    plot(re$Date,re$Voltage,type="l", ylab="Voltage", xlab="datetime")
    ...
    plot(re$Date,re$Global_reactive_power,type="l", xlab="datetime", ylab="Global_reactive_power")
